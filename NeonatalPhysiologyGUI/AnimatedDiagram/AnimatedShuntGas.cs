...
namespace NeonatalPhysiologyGUI.AnimatedDiagram
{
    public class AnimatedShuntGas
    {
        ...
        public List<GasConnector> connectors = new List<GasConnector>();
        ...
        public AnimatedShuntGas(float _dpi)
        {
            dpi = _dpi;
        ...
        public void AddConnector(GasConnector c)
        {
            connectors.Add(c);
        }
        ...
        public void DrawConnector(SKCanvas canvas, float _radX, float _radY)
        {
            ...
            foreach (GasConnector c in connectors)
            {
                totalFlow += (float)c.real_flow * Speed;
                if (totalFlow >= 0)
                {
